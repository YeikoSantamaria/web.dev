...
{% Img src="image/admin/h1QidJnqWmFsk25yq1iu.png", alt="Two cells in the filmstrip, showing screenshots before and after the layout shift.", width="800", height="341", caption="Two cells in the filmstrip, showing screenshots before and after the layout shift." %}
...
{% Img src="image/admin/hlbsiYTsFfVjpNk18ii4.png", alt="Web font header appearing out of nowhere.", width="800", height="336", caption="Web font header appearing out of nowhere." %}
...
{% Img src="image/admin/hF2EmHSpJArXA6TQ6Cm7.png", alt="The data table is rendered with placeholder data.", width="800", height="486", caption="The data table is rendered with placeholder data." %}
...
{% Img src="image/admin/1BJlP3HxeynRw0gRt52H.png", alt="WebPageTest filmstrip showing both sites loading side-by-side with and without layout optimizations.", width="800", height="288", caption="WebPageTest filmstrip showing both sites loading side-by-side with and without layout optimizations." %}
