...
<figure class="w-figure">
  ![Screenshots of Chrome DevTools showing Truebil Lite's build size before and after code splitting.](chunking.png)
...
<figure class="w-figure">
  ![Screenshots of Chrome DevTools showing Truebil Lite's time to First Meaningful Paint before and after inlining CSS.](first-meaningful-paint.png)
  <figcaption class="w-figcaption">
...
<figure class="w-figure">
  ![Screenshots of Chrome DevTools showing the effect of rel=preconnect.](preconnect.png)
  <figcaption class="w-figcaption">
...
<figure class="w-figure">
  ![Screenshots of the Truebil Lit app and Chrome DevTools showing that network requests aren't needed on common navigations because the assets have already been prefetched.](prefetch.png)
  <figcaption class="w-figcaption">
...
<figure class="w-figure">
  ![A screenshot of the Truebil Lite app in offline mode.](grayscale.png)
  <figcaption class="w-figcaption">
...
<figure class="w-figure">
  ![A screenshot of Truebil Lite's time-based installation prompt banner.](notification.png)
</figure>
