...
{% Img src="image/admin/jWmCabXZCB6zNwQIR90I.png", alt="Phone powering up an NFC tag to exchange data", width="800", height="489", caption="Phone powering up an NFC tag to exchange data" %}
...
{% Img src="image/admin/zTEXhIx9nDWtbKrIPN0x.png", alt="Phone scanning several NFC tags", width="800", height="383", caption="Phone scanning several NFC tags" %}
...
{% Img src="image/admin/uUBxSkSc3MJBG8Lw52fV.jpg", alt="Photo of a transparent NFC tag", width="800", height="450", caption="Photo of a transparent NFC tag" %}
...
{% Img src="image/admin/50clBWSJbKkyumsxrioB.png", alt="Diagram of an NDEF message", width="800", height="243", caption="Diagram of an NDEF message" %}
...
{% Img src="image/admin/PjUcOk4zbtOFJLXfSeSD.png", alt="Screenshot of a Web NFC prompt on a website", width="800", height="407", caption="Screenshot of a Web NFC prompt on a website" %}
