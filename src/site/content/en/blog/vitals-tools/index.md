...
<figure class="w-figure">
  ![Summary of Chrome and Search Tools that support the Core Web Vitals metrics](./Vitals-Tools1.png)
</figure>
...
<figure class="w-figure">
  ![Lighthouse 6.0 showing the latest Core Web Vitals metrics](./lighthouse.png)
</figure>
...
<figure class="w-figure">
  ![Lighthouse CI displaying a diff view with Largest Contentful Paint](./lhci.png)
</figure>
...
<figure class="w-figure">
  ![PageSpeed Insights with Core Web Vitals data displayed for field and lab](./pagespeed.png)
</figure>
...
<figure class="w-figure">
  ![Chrome User Experience Report API demo showing Core Web Vitals metrics](./Vitals-Tools5.png)
</figure>
...
<figure class="w-figure">
  ![Chrome UX Report dashboard displaying the Core Web Vitals metrics in a new landing page](./crux-dashboard.png)
</figure>
...
<figure class="w-figure">
  ![Cumulative Layout Shift displayed with red records in the Performance panel](./Vitals-Tools7.png)
</figure>
...
<figure class="w-figure">
  ![Total Blocking Time displayed in the footer of the DevTools performance panel](./Vitals-Tools8.png)
</figure>
...
<figure class="w-figure">
  ![Search Console's new Core Web Vitals Report](./search-console.png)
</figure>
...
<figure class="w-figure">
  ![Measure Core Web Vitals metrics over time and get prioritized guidance with the web.dev measure tool](./web-dev-measure.png)
</figure>
...
<figure class="w-figure">
  ![Core Web Vitals displayed in real-time with the Web Vitals Chrome Extension](./Vitals-Tools10.png)
</figure>
