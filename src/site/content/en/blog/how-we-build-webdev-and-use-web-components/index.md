...
{% Img src="image/admin/0vvvEFtKSNNvD79QS2i2.png", alt="A diagram that shows the relationship between global state and HTML elements that use it.", width="640", height="220", caption="A diagram that shows the relationship between global state and HTML elements that use it." %}
