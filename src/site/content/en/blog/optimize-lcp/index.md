...
{% Img src="image/admin/uB0Sm56R88MRF16voQ1k.png", alt="Largest Contentful Paint distributions before and after HTML caching", width="800", height="495", caption="Largest Contentful Paint distributions before and after HTML caching" %}
...
{% Img src="image/admin/vQXSKrY1Eq3CKkNbu9Td.png", alt="Example of LCP improvement: Before and after minifying CSS", width="800", height="139", caption="Example of LCP improvement: Before and after minifying CSS" %}
...
+   For any CSS not needed for initial rendering, use
    ...
    ```
{% Img src="image/admin/2fcwrkXQRQrM8w1qyy3P.png", alt="Example of LCP improvement: Before and after deferring non-critical CSS", width="800", height="139", caption="Example of LCP improvement: Before and after deferring non-critical CSS" %}
...
{% Img src="image/admin/m0n0JsLpH9JsNnXywSwz.png", alt="Critical CSS inlined", width="800", height="325", caption="Critical CSS inlined" %}
...
{% Img src="image/admin/L8sc51bd3ckxwnUfczC4.png", alt="Example of LCP improvement: Before and after inlining critical CSS", width="800", height="175", caption="Example of LCP improvement: Before and after inlining critical CSS" %}
...
{% Img src="image/admin/Ckh2Jjkoh7ojLj5Wxeqc.png", alt="Example of LCP improvement: Before and after Brotli compression ", width="800", height="139", caption="Example of LCP improvement: Before and after Brotli compression " %}
...
{% Img src="image/admin/sm9s16UHfh8a5MDEWjxa.png", alt="Example of LCP improvement: Before and after pre-rendering", width="800", height="139", caption="Example of LCP improvement: Before and after pre-rendering" %}
